---
title: "@cypher-zk/sdk: TypeScript SDK for Cypher Prediction"
sidebarTitle: "Overview"
description: "Everything you need to build on Cypher: a typed TypeScript SDK covering the on-chain client, React hooks, utilities, and raw instruction builders."
---

`@cypher-zk/sdk` is the official TypeScript library for interacting with the Cypher prediction market protocol on Solana. It wraps every on-chain instruction in a strongly-typed API, ships pre-built React hooks backed by TanStack Query, and exposes Arcium MPC encryption helpers so your users' bet amounts and sides remain private end-to-end.
...
|---|---|---|
| `PROGRAM_ID` | `cyphPe923…oh2B` | Deployed Cypher program address |
