...
See [Errors → ReadonlyWalletError](/sdk/reference/errors#readonlywalleterror) for the full type and handling pattern.
...
const client = new CypherClient({
  ...
  wallet,
  cluster: "devnet",
  rpcOptions: { concurrency: 10 }, // default 5
});
```

See [`CypherClientOptions.rpcOptions`](/sdk/reference/client#constructor-options) for the full shape.
...
<Prompt
  description="Add cypher-skill to your project - covers CypherProvider setup, all React hooks, onProgress patterns, x25519 secret persistence, and market phase gating."
