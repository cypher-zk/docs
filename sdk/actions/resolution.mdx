...
## flagResolution <Badge color="purple" size="sm">v0.2+</Badge>
...
## finalizeResolution <Badge color="purple" size="sm">v0.2+</Badge>
...
## adminOverrideResolution <Badge color="purple" size="sm">v0.2+</Badge>
