...
<Warning>
  Clearing browser data or switching to a different device removes this key.
  Your side shows as "encrypted" in the UI - but your bet and payout are
  completely safe. The protocol already knows the result from the Arcium
  decryption at settlement. You don't need the key to claim.
</Warning>
